...
class InquiriesControllerTest < ActionController::TestCase
  ...
  test "should create inquiry" do
    assert_difference('Inquiry.count') do
      post :create, inquiry: { accepted_datetime: @inquiry.accepted_datetime, contents: @inquiry.contents, dept_id: @inquiry.dept_id, inquired_person: @inquiry.inquired_person }
    end
  ...
  test "should update inquiry" do
    patch :update, id: @inquiry, inquiry: { accepted_datetime: @inquiry.accepted_datetime, contents: @inquiry.contents, dept_id: @inquiry.dept_id, inquired_person: @inquiry.inquired_person }
    assert_redirected_to inquiry_path(assigns(:inquiry))
  end
